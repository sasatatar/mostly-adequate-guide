...
//   }).join(', ');
// };
var availablePrices = compose(join(', '), _.map(compose(accounting.formatMoney, _.prop('dollar_value'))), filter(_.prop('in_stock')));
...
var fastestCar = compose(append(' is the fastest'), _.prop('name'), _.last, _.sortBy(_.prop("horsepower")))
